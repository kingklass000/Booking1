    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='booking_app.hotel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_number_en', models.PositiveSmallIntegerField(null=True)),
                ('room_number_ru', models.PositiveSmallIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_book', models.CharField(choices=[('отменено', 'отменено'), ('потверждено', 'потверждено')], max_length=16)),
